...
class ImageClassificationWorker(QThread):
    ...
    def run(self):
        try:
            ...
            try:
                processor = AutoProcessor.from_pretrained(r"C:\Users\MAY02\Documents\prj\model")
                model = AutoModel.from_pretrained(r"C:\Users\MAY02\Documents\prj\model").to(device)
                model.eval()
            ...
            example_images_folder = "ExampleImages"
...
class ImageClassificationApp(QWidget):
    ...
    def initUI(self):
        ...
        source_browse.setStyleSheet("background: #4a86e8; border: none; border-radius:5px; margin-right: 10px;")
        ...
        dest_browse.setStyleSheet("background: #4a86e8; border: none; border-radius:5px; margin-left: 10px;")
...
if __name__ == "__main__":
    ...
    app.setStyle("Fusion")
    app_icon_path = "organization-chart.png"
    if os.path.exists(app_icon_path):
        app_icon = QIcon(app_icon_path)
